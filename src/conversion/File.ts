        ...
        if (this.imageData && (Math.log2(this.imageData.width) % 1 !== 0 || Math.log2(this.imageData.height) % 1 !== 0)) {
            this.warning = {
                ...
                description: `
                    ...
                    <pre style="margin-block: .25em"><code style="font-size: 0.8em">2ⁿ = 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096 ...</code></pre>
                    <pre style="margin-block: .25em"><code style="font-size: 0.8em">2ᵐ = 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096 ...</code></pre>
                `
            };
        }
